...
-- ----------------------------
-- Table structure for index_name
-- ----------------------------
...
CREATE TABLE `index_name`  (
                               ...
                               `show_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
                               `create_time` datetime(0) DEFAULT CURRENT_TIMESTAMP,
                               PRIMARY KEY (`id`) USING BTREE,
                               UNIQUE INDEX `index`(`index`) USING BTREE,
                               UNIQUE INDEX `show_name`(`show_name`) USING BTREE
